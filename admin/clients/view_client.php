    ...
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a class="btn btn-light btn-flat btn-sm border" href="./?page=clients"><i class="fa fa-angle-left"></i> Arrière</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container-fluid">
                <fieldset>
                    <legent class="text-muted h4">Information Client</legent>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Code. Ref</th>
                                <th class="text-center">Politique</th>
                                <th class="text-center">Catégorie</th>
                                <th class="text-center">Date d'assurance</th>
