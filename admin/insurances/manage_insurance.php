...
<div class="container-fluid">
    <form action="" id="insurance-form">
        ...
        <div class="form-group">
            <label for="policy_id" class="control-label">Politique d'Assurance</label>
        ...
        <div class="form-group">
            <label for="registration_date" class="control-label">Date d'enregistrement</label>
        ...
        <div class="form-group">
            <label for="registration_no" class="control-label">Numéro d'immatriculation du véhicule.</label>
            <input type="registration_no" name="registration_no" id="registration_no" class="form-control form-control-sm form-control-border" placeholder="Entrez le numéro d'immatriculation du véhicule." value ="<?php echo isset($registration_no) ? $registration_no : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="chassis_no" class="control-label">Numéro de châssis du véhicule</label>
            <input type="text" name="chassis_no" id="chassis_no" class="form-control form-control-sm form-control-border" placeholder="Numéro de châssis du véhicule" value ="<?php echo isset($chassis_no) ? $chassis_no : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="vehicle_model" class="control-label">Modèle de véhicule</label>
            <input type="text" name="vehicle_model" id="vehicle_model" class="form-control form-control-sm form-control-border" placeholder="Modèle de véhicule" value ="<?php echo isset($vehicle_model) ? $vehicle_model : '' ?>" required>
        </div>
        <div class="form-group">
    ...
    function cal_xpyr(){
        ...
        if(id > 0 && registration_date !=''){
            $.ajax({
                ...
                error:err=>{
                    console.log(err)
                    alert_toast("Impossible d'obtenir la date d'expiration.",'error')
                },
