...
<div class="content py-3">
    <div class="card card-outline card-primary shadow rounded-0">
        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
                    <fieldset class="border-bottom">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="client_name" class="control-label">Nom</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="client_address" class="control-label">Adresse</label>
                    ...
                    <fieldset>
                        <legend class="text-muted">Informations sur l'impression</legend>
                        <div class="row align-items-end">
                            <div class="form-group col-md-4">
                                <label for="price_id" class="control-label">Article</label>
                            ...
                            <div class="form-group col-md-2">
                                <button class="btn btn-flat btn-primary" type="button" id="add_to_list"><i class="fa fa-plus"></i> Ajouter Article</button>
                            </div>
                        </div>
                    ...
                    <fieldset>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="amount" class="control-label">Paiement/Paiement partiel</label>
        ...
        <div class="card-footer text-right">
            <button class="btn btn-flat btn-primary btn-sm" type="submit" form="transaction_form">Enregistrer la transaction</button>
            <a href="./?page=transactions" class="btn btn-flat btn-default border btn-sm">Annuler</a>
        </div>
    </div>
</div>
...
<script>
    ...
    $(function(){
        $('#price_id').select2({
            placeholder:'Veuillez sélectionner l\'article ici',
            width:'100%'
        })
        ...
        $('#add_to_list').click(function(){
            ...
            if(price_id == ''){
                alert_toast('Sélectionnez d\'abord l\'article','warning')
                return false;
            }
            if(!!price_arr[price_id]){
                ...
                alert_toast('Article inconnu','warning')
                return false;
            }
        })
        $('#transaction_form').submit(function(e){
            ...
            if($('#item-list tbody tr').length <= 0){
                alert_toast(" Veuillez d'abord ajouter au moins 1 élément.",'warning')
                return false;
            }
            start_loader();
            $.ajax({
